...
## coRdon
#### Codon Usage Analysis & Prediction of Gene Expressivity

### <i class="fa fa-list-ul" aria-hidden="true"></i> About
<br>
__coRdon__ is an R package for analysis and visualization of codon usage in DNA sequences.
...
please see [the package vignette](articles/coRdon.html).

***

### <i class="fa fa-file" aria-hidden="true"></i> Citation
<br>
TBA
