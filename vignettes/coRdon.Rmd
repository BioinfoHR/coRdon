...
#library(coRdon)
dir <- getwd()
setwd("/Users/Maja/Documents/Anamaria/coRdon/")
devtools::load_all(".")
setwd(dir)
library(ggplot2)
library(Biostrings)
...
We can already see that the genes in the healthy and diseased sample have different CU patterns.  
...
Thus created matrix, with genes in rows and samples in columns, can be directly used as an argument to `Heatmap()` function for plotting.
